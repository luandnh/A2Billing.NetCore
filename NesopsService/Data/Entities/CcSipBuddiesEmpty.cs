...
{
    public partial class CcSipBuddiesEmpty
    {
        public CcSipBuddiesEmpty()
        {
        ...
        public string Restrictcid { get; set; }

        public string Rtptimeout { get; set; }

        public string Rtpholdtimeout { get; set; }
        ...
        public string Cancallforward { get; set; }
        ...
        public string Incominglimit { get; set; }
        ...
        public string Maxcallbitrate { get; set; }

        public string Outboundproxy { get; set; }

        public string Rtpkeepalive { get; set; }
