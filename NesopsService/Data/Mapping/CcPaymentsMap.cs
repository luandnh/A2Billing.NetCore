...
{
    public partial class CcPaymentsMap
        : IEntityTypeConfiguration<NesopsService.Data.Entities.CcPayments>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<NesopsService.Data.Entities.CcPayments> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("cc_payments");
            ...
            builder.Property(t => t.CustomersId)
                .IsRequired()
                .HasColumnName("customers_id")
                .HasColumnType("bigint(20)");

            builder.Property(t => t.CustomersName)
                .IsRequired()
                .HasColumnName("customers_name")
                .HasColumnType("varchar(200)")
                .HasMaxLength(200);

            builder.Property(t => t.CustomersEmailAddress)
                .IsRequired()
                .HasColumnName("customers_email_address")
        ...
        public const string TableName = "cc_payments";

        public const string ColumnId = "id";
        public const string ColumnCustomersId = "customers_id";
        public const string ColumnCustomersName = "customers_name";
        public const string ColumnCustomersEmailAddress = "customers_email_address";
